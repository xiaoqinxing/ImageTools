...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.focus_length = QtWidgets.QSpinBox(self.formLayoutWidget)
        self.focus_length.setMinimum(1)
        self.focus_length.setMaximum(200)
        self.focus_length.setProperty("value", 50)
