...
class Ui_ImageEditor(object):
    def setupUi(self, ImageEditor):
        ...
        self.deletephoto = QAction(ImageEditor)
        self.deletephoto.setObjectName(u"deletephoto")
        icon7 = QIcon()
        icon7.addFile(u":/tool_icon/resource/delete.png", QSize(), QIcon.Normal, QIcon.Off)
        self.deletephoto.setIcon(icon7)
...
#if QT_CONFIG(shortcut)
        self.nextphoto.setShortcut(QCoreApplication.translate("ImageEditor", u"Down", None))
#endif // QT_CONFIG(shortcut)
        self.prephoto.setText(QCoreApplication.translate("ImageEditor", u"\u4e0a\u4e00\u5f20\u56fe\u7247", None))
#if QT_CONFIG(shortcut)
        self.prephoto.setShortcut(QCoreApplication.translate("ImageEditor", u"Up", None))
#endif // QT_CONFIG(shortcut)
        self.deletephoto.setText(QCoreApplication.translate("ImageEditor", u"\u5220\u9664", None))
#if QT_CONFIG(tooltip)
        self.deletephoto.setToolTip(QCoreApplication.translate("ImageEditor", u"\u5220\u9664", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(shortcut)
        self.deletephoto.setShortcut(QCoreApplication.translate("ImageEditor", u"Del", None))
#endif // QT_CONFIG(shortcut)
