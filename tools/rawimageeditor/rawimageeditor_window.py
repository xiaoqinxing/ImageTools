...
class Ui_ImageEditor(object):
    def setupUi(self, ImageEditor):
        ...
        self.buttonGroup = QButtonGroup(ImageEditor)
        self.buttonGroup.setObjectName(u"buttonGroup")
        self.buttonGroup.addButton(self.radioButton_3)
        self.radioButton_3.setObjectName(u"radioButton_3")

        self.gridLayout_10.addWidget(self.radioButton_3, 2, 0, 1, 1)

        self.radioButton = QRadioButton(self.groupBox_8)
        self.buttonGroup.addButton(self.radioButton)
        self.radioButton.setObjectName(u"radioButton")

        self.gridLayout_10.addWidget(self.radioButton, 4, 0, 1, 1)
    ...
    def retranslateUi(self, ImageEditor):
        ...
        self.radioButton_3.setText(QCoreApplication.translate("ImageEditor", u"RadioButton", None))
        self.radioButton.setText(QCoreApplication.translate("ImageEditor", u"RadioButton", None))
        self.radioButton_2.setText(QCoreApplication.translate("ImageEditor", u"\u53cc\u7ebf\u6027\u63d2\u503c", None))
